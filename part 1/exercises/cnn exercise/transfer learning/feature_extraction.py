...
fc7 = AlexNet(resized, feature_extract=True)#takes inpur the resized images and feature extract is true
...
fw8= tf.variable(tf.truncated_normal(shape,stddev=1e-2)# the stddev parameter is 
fb8=tf.variable(tf.zeroes(nb_classes))
